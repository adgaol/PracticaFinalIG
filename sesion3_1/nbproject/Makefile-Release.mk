...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/sesion3_1.exe: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/sesion3_1 ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/nbproject/private/c_standard_headers_indexer.o: nbproject/private/c_standard_headers_indexer.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/nbproject/private/c_standard_headers_indexer.o nbproject/private/c_standard_headers_indexer.c
...
${OBJECTDIR}/src/Mesh.o: src/Mesh.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Mesh.o src/Mesh.cpp
